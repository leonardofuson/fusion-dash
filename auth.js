...
(function () {
  ...
  const DASHES = {
    ...
    'lojas-lynx': { titulo: 'Lojas Lynx', descricao: 'Espelho das vendas registradas no Linx Microvix (POC migração)', url: '/lojas-lynx.html', icone: '🏪', restritoPara: ['leonardo@usefusion.com.br', 'tales@usefusion.com.br'] },
